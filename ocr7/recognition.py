...
class Recognizer:
    ...
    Args:
        ...
        build_params: A dictionary of build parameters for the model.
            See `ocr7.detection.build_model` for details.
        ...
        if weights is not None:
            ...
            if alphabet == weights_dict['alphabet']:
                self.model.load_weights(
                    utils.download_and_verify(url=weights_dict['weights']['top']['url'],
                ...
                self.backbone.load_weights(
                    utils.download_and_verify(url=weights_dict['weights']['notop']['url'],
    ...
    def recognize(self, image):
        ...
        """
        image = utils.read_and_fit(filepath_or_array=image,
